INSERT INTO users (name,email,firstname,lastname) values ('Terminator','terminator@gmail.com','Nadir','Yüceer');
INSERT INTO users (name,email,firstname,lastname) values ('PcNerd', 'thenerd@yahoo.com','Ahmet','Vural' );
