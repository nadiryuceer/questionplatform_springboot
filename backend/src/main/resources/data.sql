INSERT INTO users (username,email,firstname,lastname) values ('Terminator','terminator@gmail.com','Nadir','Yüceer');
INSERT INTO users (username,email,firstname,lastname) values ('PcNerd', 'thenerd@yahoo.com','Ahmet','Vural' );
